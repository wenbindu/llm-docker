...
if __name__=="__main__":
    ...
    # with open("bird.webp", "rb") as f:
    #    image = f.read()
    img = cv2.imread("bird.webp")
    # Encode the image as a JPEG (or another format)
    ...
    data = [
        {
            "data": {
                "image": base64.b64encode(img_bytes).decode("utf-8"), # base64.b64encode(image).decode("utf-8")
                "caption": "bird",
                "box_threshold": 0.25,
